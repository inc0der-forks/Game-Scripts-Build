...
*/
import { Picture2D, Tree, Game } from "../Core";
...
class Message extends Graphic.Base {
     ...
     */
    drawFaceset(x, y, w, h) {
        this.faceset.draw(x + Utils.defaultValue(Datas.Systems.dbOptions.v_fX, 0), y - ((this.faceset.oH - h) / 2) + Utils.defaultValue(Datas
